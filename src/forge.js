...
class Forge {
	...
	_handleClick() {
		...
		const tracks = ['Rock', 'Etica', 'Forge', 'Pox', 'Dur', 'Macadam'];
		const band = ['The Forge', 'The Forge', 'The Forge', 'Small Pox', 'Le Forge', 'Macadam Forge'];
		const times = ['4:07', '32:44', '39:00', '29:35', '19:00', '8:11'];
		const tracklist = [
		...
		const titles = ['Rock\'n\'Roll', 'Etica Nikomak', 'The Forge', 'Small Pox', 'Dur d\'Être Apache...', 'Loulou/Montpar\' Blues'];
		...
		const youtube = ['v=wap0ZVifTfA', 'v=v8yQdRsJah4&list=PLGrV25VkQxOeALepofxUafUZR2_4Hhy8K', 'v=4JecXQAe7nQ&list=PLGrV25VkQxOdBaIl_kHM0Z9mjq_1D3LrK', 'v=VRg5BQkyIiE&list=PLGrV25VkQxOde4ci3lta5oX6WJbPb7iXU', 'v=ZuLNodgTtzI&list=PLGrV25VkQxOdkK4Hjc80bQ5pdcBfB9N_M', 'v=NjlcpdkZnb8&list=PLGrV25VkQxOfFnRPT0QqYXeIk-hNdPvQO'];
		const discogs = ['21011362-The-Forge-RocknRoll', '20503012-The-Forge-Etica-Nikomak', '20560249-The-Forge-The-Forge', '20548198-Small-Pox-Small-Pox', '20515321-Le-Forge-Dur-dÊtre-Apache', '21012571-Macadam-Forge-Loulou-Montpar-Blues'];
		...
		const bandcamp = ['rocknroll-single', 'etica-nikomak', 'the-forge', 'small-pox', 'dur-d-tre-apache', 'loulou-montpar-blues-single'];
		const dates = {
			fr: ['15 Novembre 2021', '7 Octobre 2021', '6 Octobre 2021', '5 Octobre 2021', '4 Octobre 2021', '17 Novembre 2021'],
			en: ['November 15, 2021', 'October 7, 2021', 'October 6, 2021', 'October 5, 2021', 'October 4, 2021', 'November 17, 2021']
		};
